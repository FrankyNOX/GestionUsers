    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-4 text-gray-800">Créer un Utilisateur</h1>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group focused">
                                                    ...
                                                    <input type="password" id="confirm_password" class="form-control" name="password_confirmation" placeholder="Confirm mt de passe">
                                                </div>
                                            </div>
                                        </div>
